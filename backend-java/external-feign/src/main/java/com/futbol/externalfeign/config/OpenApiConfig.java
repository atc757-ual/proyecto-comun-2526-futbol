package com.futbol.externalfeign.config;
...
public class OpenApiConfig {
    ...
    @Value("${openapi.title:External Feign API}")
    private String title;

    @Value("${openapi.description:Proxy Feign para integraciones externas del ecosistema Futbol 2526}")
