...
export const routes: Routes = [
  ...
  // 3. MAIN LAYOUT (Todo lo demás protegido)
  {
    ...
    children: [
      ...
      { path: 'news', loadComponent: () => import('./features/news/list-news/news.page').then(m => m.NewsPage) },
      { path: 'news/:id', loadComponent: () => import('./features/news/news-detail/news-detail.page').then(m => m.NewsDetailPage) },
