...
import { IonicModule, MenuController, NavController, ActionSheetController, ModalController } from '@ionic/angular';
...
describe('MainLayoutComponent', () => {
  ...
  beforeEach(waitForAsync(() => {
    ...
    const layoutServiceMock = jasmine.createSpyObj('LayoutService', ['showHero', 'title', 'subtitle', 'breadcrumbs']);
    ...
    authServiceMock.currentUser.and.returnValue({ id: '123', email: 'test@test.com' });
  ...
  describe('onBreadcrumbClick guards', () => {
    ...
    it('should allow navigation if user is logged in', () => {
      authServiceSpy.currentUser.and.returnValue({ id: '123', email: 'test@test.com' });
      const mockEvent = jasmine.createSpyObj('Event', ['preventDefault', 'stopPropagation']);
      const mockItem = { url: '/home', label: 'Inicio' };
